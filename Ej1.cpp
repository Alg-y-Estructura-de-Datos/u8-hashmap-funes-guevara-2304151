/*Simulación de un pequeño diccionario.
 * Utilizaremos el HashMap para almacenar pares de palabras (clave) y sus significados (valor).
 * El usuario podrá:
 * ● Agregar nuevas palabras y sus significados.
 * ● Buscarel significado de una palabra.
 * ● Eliminar una palabra del diccionario.
 * ● Vertodaslas palabras en el diccionario.*/
